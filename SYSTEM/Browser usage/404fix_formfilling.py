...
def answer_question(mcp: MCPClient, question: dict, answer) -> bool:
    ...
    # Pause keepalive during interaction to prevent session conflicts
    mcp.pause_keepalive()
...
def run_form_agent(form_url: str):
    ...
    for page_num in range(1, MAX_PAGES + 1):
        ...
        # Pause keepalive during navigation click
        mcp.pause_keepalive()
